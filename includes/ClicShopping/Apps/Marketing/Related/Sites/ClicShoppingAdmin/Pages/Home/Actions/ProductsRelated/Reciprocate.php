<?php
  ...
  class Reciprocate extends \ClicShopping\OM\PagesActionsAbstract
  {
    public function execute()
    {
      ...
      $products_id_view = isset($_POST['products_id_view']) ? HTML::sanitize($_POST['products_id_view']) : '';
      ...
      if ($products_related_id_master != $products_related_id_slave) {
        ...
        if ($Qcheck->fetch() === false) {
          ...
          $CLICSHOPPING_Db->save('products_related', ['products_related_id_master' => (int)$products_related_id_slave,
              'products_related_id_slave' => (int)$products_related_id_master,
              'products_related_sort_order' => (int)$products_related_sort_order,
              'products_cross_sell' => (int)$products_cross_sell,
              'products_related' => (int)$products_related,
              'products_mode_b2b' => (int)$products_mode_b2b
      ...
      $CLICSHOPPING_Related->redirect('ProductsRelated&' . $page_info . '&products_related_id_master=' . $products_related_id_master . '&products_related_id_slave=' . $products_related_id_slave . '&products_id_view=' . $products_id_view);
    }
  }