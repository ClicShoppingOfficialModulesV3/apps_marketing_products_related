 ...
 */
  ...
  class pi_products_info_related {
    public $code;
    public $group;
    public $title;
    public $description;
    ...
    public function __construct() {
      ...
      $this->title = CLICSHOPPING::getDef('module_products_info_related');
      $this->description = CLICSHOPPING::getDef('module_products_info_related_description');

      if (defined('MODULE_PRODUCTS_INFO_RELATED_STATUS')) {
        $this->sort_order = MODULE_PRODUCTS_INFO_RELATED_SORT_ORDER;
        $this->enabled = (MODULE_PRODUCTS_INFO_RELATED_STATUS == 'True');
      }
    }
      ...
      if ($CLICSHOPPING_ProductsCommon->getID() && isset($_GET['Products'])) {
        ...
        $products_id = $CLICSHOPPING_ProductsCommon->getID();
         ...
         if ($CLICSHOPPING_Customer->getCustomersGroupID() == 0) {
            ...
            $Qproducts->bindInt(':limit', MODULE_PRODUCTS_INFO_RELATED_MAX_DISPLAY);
            $Qproducts->execute();
          } else { // mode B2B
            $Qproducts = $CLICSHOPPING_Db->prepare('select pr.products_related_id_slave,
                                                           p.products_image,
                                                    ...
                                                    and pr.products_related_id_master = :products_related_id_maste
                                                    and p.products_status = 1
                                                    and p.products_archive = 0
                                                    and pr.products_related = 1
...
// display number of short description
            $products_short_description_number = (int)MODULE_PRODUCTS_INFO_RELATED_SHORT_DESCRIPTION;
// delete words
            $delete_word = (int)MODULE_PRODUCTS_INFO_RELATED_SHORT_DESCRIPTION_DELETE_WORLDS;
// nbr of column to display  boostrap
          $bootstrap_column = (int)MODULE_PRODUCTS_INFO_RELATED_COLUMNS;
// initialisation des boutons
            $size_button = $CLICSHOPPING_ProductsCommon->getSizeButton('xs');

// Template define
            $filename= '';
            $filename = $CLICSHOPPING_Template-> getTemplateModulesFilename($this->group .'/template_html/' . MODULE_PRODUCTS_INFO_RELATED_TEMPLATE);

            $new_prods_content = '<!-- Start products_related -->' . "\n";
            ...
            if (MODULE_PRODUCTS_INFO_RELATED_TITLE == 'True') {
              $new_prods_content .= '<div>';
              $new_prods_content .= '<div class="productsInfoRelatedProductsTitle"><span class="productsInfoRelatedProductsTitle"><h2>' . sprintf(CLICSHOPPING::getDef('module_products_info_related_name'), strftime('%B')) . '</h2></span></div>';
              $new_prods_content .= '</div>';
            }

            $new_prods_content .= '<div class="ModuleProductsInfoRelatedContainer">';
...
//Stock (good, alert, out of stock).
              $products_stock = $CLICSHOPPING_ProductsFunctionTemplate->getStock(MODULE_PRODUCTS_INFO_RELATED_DISPLAY_STOCK, $products_id);
//Flash discount
...
//Ticker Image
              $products_image .= $CLICSHOPPING_ProductsFunctionTemplate->getTicker(MODULE_PRODUCTS_INFO_RELATED_TICKER, $products_id, 'ModulesProductsInfoBootstrapTickerSpecial', 'ModulesProductsInfoBootstrapTickerFavorite', 'ModulesProductsInfoBootstrapTickerFeatured', 'ModulesProductsInfoBootstrapTickerNew');

              $ticker = $CLICSHOPPING_ProductsFunctionTemplate->getTickerPourcentage(MODULE_PRODUCTS_INFO_RELATED_POURCENTAGE_TICKER, $products_id, 'ModulesProductsInfoBootstrapTickerPourcentage');
...
// **************************
            ...
            $new_prods_content .= '<!-- end products_related --><br />' . "\n";
    ...
    public function check() {
      return defined('MODULE_PRODUCTS_INFO_RELATED_STATUS');
    }
    ...
    public function install() {
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_INFO_RELATED_STATUS',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_INFO_RELATED_TEMPLATE',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_INFO_RELATED_TITLE',
          'configuration_value' => 'True',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_INFO_RELATED_MAX_DISPLAY',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_INFO_RELATED_COLUMNS',
          'configuration_value' => '6',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_INFO_RELATED_SHORT_DESCRIPTION',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_INFO_RELATED_SHORT_DESCRIPTION_DELETE_WORLDS',
          'configuration_value' => '0',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_INFO_RELATED_TICKER',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_INFO_RELATED_POURCENTAGE_TICKER',
          'configuration_value' => 'False',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_INFO_RELATED_DISPLAY_STOCK',
       ...
       $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_INFO_RELATED_IMAGE_WIDTH',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_INFO_RELATED_IMAGE_HEIGHT',
          'configuration_value' => '130',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          'configuration_title' => 'Ordre de tri d\'affichage',
          'configuration_key' => 'MODULE_PRODUCTS_INFO_RELATED_SORT_ORDER',
    ...
    public function keys() {
      return array (
        'MODULE_PRODUCTS_INFO_RELATED_STATUS',
        'MODULE_PRODUCTS_INFO_RELATED_TEMPLATE',
        'MODULE_PRODUCTS_INFO_RELATED_TITLE',
        'MODULE_PRODUCTS_INFO_RELATED_MAX_DISPLAY',
        'MODULE_PRODUCTS_INFO_RELATED_COLUMNS',
        'MODULE_PRODUCTS_INFO_RELATED_SHORT_DESCRIPTION',
        'MODULE_PRODUCTS_INFO_RELATED_SHORT_DESCRIPTION_DELETE_WORLDS',
        'MODULE_PRODUCTS_INFO_RELATED_TICKER',
        'MODULE_PRODUCTS_INFO_RELATED_POURCENTAGE_TICKER',
        'MODULE_PRODUCTS_INFO_RELATED_DISPLAY_STOCK',
        'MODULE_PRODUCTS_INFO_RELATED_IMAGE_WIDTH',
        'MODULE_PRODUCTS_INFO_RELATED_IMAGE_HEIGHT',
        'MODULE_PRODUCTS_INFO_RELATED_SORT_ORDER'
      );
    }
  }
